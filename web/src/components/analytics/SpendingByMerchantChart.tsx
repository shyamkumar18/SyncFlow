...
interface SpendingByMerchantChartProps {
  data: MerchantData[];
}

export default function SpendingByMerchantChart({ data }: SpendingByMerchantChartProps) {
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} layout="vertical" margin={{ left: 80 }}>
            ...
            <Bar dataKey="total" fill="var(--color-primary-600)" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
