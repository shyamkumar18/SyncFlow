...
const NAV_ITEMS = [
  ...
  { path: '/help', label: 'Help Centre', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1A1D21] flex">
      <aside className="w-64 bg-white dark:bg-[#23272E] border-r border-gray-200 dark:border-gray-700 hidden lg:flex flex-col">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <Link to="/" className="text-2xl font-bold text-primary-600">$yncFlow</Link>
        </div>
